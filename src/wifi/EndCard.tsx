...
import { theme, useEnter } from "../backup/ui";

export const WifiEndCard: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: brand.gradient, alignItems: "center", justifyContent: "center" }}>
      <AbsoluteFill
        style={{
          backgroundImage: "radial-gradient(circle at 50% 34%, rgba(255,255,255,0.16) 0%, rgba(255,255,255,0) 58%)",
        }}
      />
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 46 }}>
        ...
        >
          {["Wi-Fi corporativo", "Segmentação", "Monitoramento", "Gestão de TI"].map((t) => (
            <div
              key={t}
              style={{
                fontFamily: brand.fontFamily,
