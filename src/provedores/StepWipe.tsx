...
export const StepWipe: React.FC = () => {
  ...
  const corte = blockRanges
    ...
    // A cartela existe para anunciar passo: onde não há passo novo — a ponte,
    // logo depois da abertura — ela interrompia o começo em vez de costurá-lo,
    // e ali quem separa os takes é a diferença de enquadramento.
    .filter((c) => c.bloco.activeSteps.length > 0)
